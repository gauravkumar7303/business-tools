...
//       icon: <FileSpreadsheet className="w-12 h-12 md:w-16 md:h-16" />,
...
//                 <div className="hidden sm:block p-2 bg-blue-100 dark:bg-blue-900 rounded-lg">
...
//               {/* Mobile only tagline */}
//               <p className="sm:hidden text-xs text-gray-600 dark:text-gray-400">
//                 Business Tools
//               </p>
//             </div>
//           </div>
...
//                     ? 'scale-105 shadow-xl dark:shadow-gray-900/50' 
...
//         {/* Bottom Info */}
//         <div className="text-center mt-8 md:mt-12 pt-6 md:pt-8 border-t dark:border-gray-700">
//           <p className="text-gray-500 dark:text-gray-400 text-sm">
//             All platforms work independently • No data sharing between tools
//           </p>
//         </div>
//       </main>
...
//       title: 'MPP File Reader',
//       description: 'Upload and analyze Microsoft Project files with Gantt charts, risk analysis, and resource tracking',
//       icon: '/Logos/MS_Project_Logo.png',
